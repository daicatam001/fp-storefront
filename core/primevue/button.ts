export default {
    root: ({ props, context, parent }) => ({
        class: [
          ...
          { 'text-slate-500 border border-gray-500': props.plain && props.outlined },
          // Text Button
          ...
          // Primary Button
          {
            ...
            'bg-black': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
            'border border-black': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain
          },
          // Primary Text Button
          ...
          // Secondary Button
          {
            ...
            'border border-slate-500 dark:border-slate-400': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain
          },
          // Secondary Text Button
          { 'text-slate-500 dark:text-slate-300': props.text && props.severity === 'secondary' && !props.plain },
          // Secondary Outlined Button
          { 'text-slate-500 dark:text-slate-300 border border-slate-500 hover:bg-slate-300/20': props.outlined && props.severity === 'secondary' && !props.plain },
          // Success Button
          {
          ...
          // Contrast Button
          {
            ...
            'bg-slate-900 dark:bg-slate-0': props.severity === 'contrast' && !props.text && !props.outlined && !props.plain,
            'border border-slate-900 dark:border-slate-0': props.severity === 'contrast' && !props.text && !props.outlined && !props.plain
          },
          // Contrast Text Button
          { 'text-slate-900 dark:text-slate-0': props.text && props.severity === 'contrast' && !props.plain },
          // Contrast Outlined Button
          { 'text-slate-900 dark:text-slate-0 border border-slate-900 dark:border-slate-0': props.outlined && props.severity === 'contrast' && !props.plain },
          ...
          // Secondary
          { 'hover:bg-slate-600 dark:hover:bg-slate-300 hover:border-slate-600 dark:hover:border-slate-300': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain },
          { 'focus:ring-slate-400/50 dark:focus:ring-slate-300/50': props.severity === 'secondary' },
          // Text & Outlined Button
          ...
          // Text & Outlined Button
          { 'hover:bg-slate-900/10 dark:hover:bg-[rgba(255,255,255,0.03)]': (props.text || props.outlined) && props.severity === 'contrast' && !props.plain },
          // Disabled
